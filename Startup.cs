...
namespace RealtimeGraphWithHostedService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSignalR(); // enable SignalR
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapHub<StockDataHub>("/stockdatahub"); // Map Hub, for .net6 map it above end point with app.MapHub<>
